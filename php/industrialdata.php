          ...
          <div class="row">
            ...
            <div class="col-xl-2 col-lg-3 col-md-4 sidebar fixed-top">
              ...
              <div class="bottom-border pb-3">
                ...
                <a href="#" class="text-white" style="font-size: 15px;">Sunkoshi</a>
              ...
              <ul class="navbar-nav flex-column mt-4">
                ...
                <i class="fas fa-building fa-lg mr-3" style="font-size: 13px;"></i><span>Organizational</span></a>
...
<section class="pertb" style="margin-top: 50px; margin-left: 220px;">
  ...
  <?php
    $con=mysqli_connect('localhost','root','','sunkoshimunicipality');
    $sql='SELECT *FROM industrial_details';
...
<div class="table-wrapper-scroll-y my-custom-scrollbar">
  <table class="table table-bordered table-striped mb-0" style="font-size: 14px;">
    <thead>
     ...
     <th scope="col">Industrial Type</th>
  ...
  <tbody>
    <?php foreach ($result as $value) {?>
      <tr>
        <th scope="row"><?php echo $value['Industry_id'];?></th>
        <td><?php echo $value['Industry_name'];?></td>
        <td><?php echo $value['Location'];?></td>
        <td><?php echo $value['Established_date'];?></td>
        <td><?php echo $value['Industry_type'];?></td>
        <td><a class="btn btn-primary" href="industrialedit.php?id=<?php echo $value['Industry_id']?>">Edit</a>
        <a class="btn btn-danger" onclick="return confirm('Are you sure you want to delete?')" href="industrialdelete.php?id=<?php echo $value['Industry_id']?>">Delete</a></td>
      </tr>
      <?php }?>
    </tbody>
  </table>
    ...
    <!-- footer -->
    <footer>
      <hr><div style="text-align: center; font-size: 14px; padding-top: 50px; padding-left: 90px;">
