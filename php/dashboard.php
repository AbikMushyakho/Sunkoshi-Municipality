          ...
          <div class="row">
            ...
            <div class="col-xl-2 col-lg-3 col-md-4 sidebar fixed-top">
              ...
              <div class="bottom-border pb-3 text-center">
                ...
                <a href="index.php" class="text-white" "><h6 >Sunkoshi Municipality</h6></a>
            ...
            <div class="col-xl-10 col-lg-9 col-md-8 ml-auto fixed-top py-2 top-navbar" style="background-color: #234a83;">
              <div class="row align-items-center">
                ...
                <div class="col-md-4" style="padding-top: 10px;">
                  <a onclick="return confirm('Are you sure you want to logout??')" href="login.php">
                  ...
                  <div class="card-body">
                    <div class="d-flex justify-content-between">
                      ...
                      <div class="text-right text-secondary">
                        ...
                        <h3>
                          <?php
                          $connection=mysqli_connect('localhost', 'root', '', 'sunkoshimunicipality');
                          $query = "Select Personal_id from personal_details order by Personal_id";
                    ...
                    <div class="d-flex justify-content-between">
                      ...
                      <div class="text-right text-secondary">
                        ...
                        <h3>
                          <?php
                          $connection=mysqli_connect('localhost', 'root', '', 'sunkoshimunicipality');
                          $query = "Select Organization_id from organizational_details order by Organization_id";
                          $query_run=mysqli_query($connection, $query);
                          $row=mysqli_num_rows($query_run);
                          echo '<h3> Total No: '.$row.'</h3>';
                          ?>
