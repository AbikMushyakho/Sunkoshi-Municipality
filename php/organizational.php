<?php
      if($_POST)
      {
        ...
        $rem ="INSERT INTO organizational_details(Organization_name, Location, Established_date, Organization_ownership, Organization_type) VALUES('$orgname', '$location', '$estdate', '$owned', '$type')";
          mysqli_query($con, $rem);
          echo "<script>alert('Data submited successfully!'); window.location='organizational.php'</script>"; 
          ...
          <div class="row">
            ...
            <div class="col-xl-10 col-lg-9 col-md-8 ml-auto fixed-top py-2 top-navbar" style="background-color: #234a83;">
              <div class="row align-items-center">
                <div class="col-md-8">
                  <h4 class="text-light text-uppercase mb-0" style="text-align: center; float: left;">ADD ORGANIZATIONAL DETAILS</h4>
                </div>
