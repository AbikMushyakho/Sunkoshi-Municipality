 <?php
      if($_POST)
      {
        ...
        else
        {
          ...
          $rem ="INSERT INTO industrial_details( Industry_name, Location, Established_date, Industry_type) VALUES ('$indname', '$location', '$estdate', '$industype')";
          ...
          <div class="row">
            ...
            <div class="col-xl-10 col-lg-9 col-md-8 ml-auto fixed-top py-2 top-navbar" style="background-color: #234a83;">
              <div class="row align-items-center">
                <div class="col-md-8">
                  <h4 class="text-light text-uppercase mb-0" style="text-align: center; float: left;">ADD INDUSTRIAL DETAILS</h4>
                </div>
