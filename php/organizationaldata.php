...
<!--Start of form-->
 <section class="pertb" style="margin-top: 50px; margin-left: 220px;">
  ...
  <?php
    ...
    $sql='SELECT *FROM organizational_details';
  ...
  <tbody> 
    <?php foreach ($result as $value) {?>
      <tr>
        ...
        <td><?php echo $value['Organization_type'];?></td>
         ...
         <td>
          <a class="btn btn-primary" href="organizationaledit.php?id=<?php echo $value['Organization_id']?>">Edit</a>
          <a class="btn btn-danger" onclick="return confirm('Are you sure you want to delete?')" href="organizationaldelete.php?id=<?php echo $value['Organization_id']?>">Delete</a>
         </td>
      </tr>
      <?php }?>
    </tbody>
    ...
    <footer>
      <hr><div style="text-align: center; font-size: 14px; padding-left: 90px;">
                <p>&copy; 2019 Sunkoshi Municipality. Developed By: <a href="http://bikesh.pb.online/"><span class="text-success">Abik Mushyakho</span></a></p>
              </div>
    </footer>
    <!-- end of footer -->
